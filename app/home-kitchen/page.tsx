...
export default function HomeKitchenPage() {
  const slides = [
    {
      title: "Best Deal Online on home appliances",
    ...
    <>
      ...
      <div className=" px-[5%] my-2">
        <div className=" flex justify-between">
          ...
          <Link href="/search?q=home kitchen" className=" flex items-center hover:text-blue transition-colors duration-300">View All<MdOutlineKeyboardArrowRight className=" text-2xl text-blue" /></Link>
        </div>
