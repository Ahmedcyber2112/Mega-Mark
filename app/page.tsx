    ...
    {Array.from({ length: slides.length }).map((_, idx) => (
      ...
      <div className=" px-[5%] my-2">
        <div className=" flex justify-between">
          ...
          <Link href="/electronics" className=" flex items-center hover:text-blue transition-colors duration-300">View All<MdOutlineKeyboardArrowRight className=" text-2xl text-blue" /></Link>
        </div>
      ...
      <div className=" grid grid-cols-1 sm:grid-cols-3 md:grid-cols-5 px-[5%] gap-10 my-[3%]">
        {DataSmart.map((item) => (
          <Link key={item.id} href={`/product?id=${item.id}&category=smart`}>
            <article className=" relative border-1 border-[#EDEDED] hover:border-blue rounded-2xl hover:scale-105 hover:shadow-lg transition-transform duration-300 cursor-pointer">
      ...
      <div className=" px-[5%] my-2">
        <div className=" flex justify-between">
          ...
          <Link href="/search?q=categories" className=" flex items-center hover:text-blue transition-colors duration-300">View All<MdOutlineKeyboardArrowRight className=" text-2xl text-blue" /></Link>
        </div>
        <div className=" h-1 mt-2 bg-[#EDEDED] rounded-full">
      ...
      <div className=" px-[5%] my-2">
        <div className=" flex justify-between">
          ...
          <Link href="/groceries" className=" flex items-center hover:text-blue transition-colors duration-300">View All<MdOutlineKeyboardArrowRight className=" text-2xl text-blue" /></Link>
        </div>
        <div className=" h-1 mt-2 bg-[#EDEDED] rounded-full">
      ...
      <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 mx-[6%] gap-5 my-[4%]">
          {DataFood.map((no) => (
            <Link key={no.id} href={`/product?id=${no.id}&category=food`}>
              <article className=" text-center rounded-lg border-1 border-[#F5F5F5] hover:border-blue hover:scale-105 transition-transform duration-300 cursor-pointer">
