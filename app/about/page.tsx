...
export default function AboutPage() {
  const slides = [
    {
      title: "Best Deal Online for everyone",
      headline: "ABOUT MEGA MARK.",
      discount: "Quality & Trust",
      image: "/Logo (2).webp",
    },
    {
      title: "Best Deal Online for everyone",
    ...
    <>
      ...
      <div className=" px-[5%] my-2">
        <div className=" flex justify-between">
          ...
          <Link href="/search?q=products" className=" flex items-center hover:text-blue transition-colors duration-300">View All<MdOutlineKeyboardArrowRight className=" text-2xl text-blue" /></Link>
        </div>
