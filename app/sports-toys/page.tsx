...
export default function SportsToysPage() {
  const slides = [
    {
      title: "Best Deal Online on sports & toys",
      headline: "SPORTS & TOYS.",
    ...
    <>
      ...
      <div className=" px-[5%] my-2">
        <div className=" flex justify-between">
          ...
          <Link href="/search?q=sports toys" className=" flex items-center hover:text-blue transition-colors duration-300">View All<MdOutlineKeyboardArrowRight className=" text-2xl text-blue" /></Link>
        </div>
